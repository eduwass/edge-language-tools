...
<Steps>
  ...
  <Step title="Link the CLIs into your project">
    ...
    No project of your own yet? Skip linking — you can run the checker directly from the clone with `bun packages/check/src/cli.ts /path/to/templates`, or the same with `node`.
  </Step>
